...
# 后台IP设置
export Ipv4_ipaddr="10.0.0.102"            # 修改openwrt后台地址(填0为关闭)
export Netmask_netm="255.255.255.0"         # IPv4 子网掩码（默认：255.255.255.0）(填0为不作修改)
export Op_name="Addlink"                # 修改主机名称为OpenWrt-123(填0为不作修改)
...
export DNS_Settings="233.5.5.5 233.6.6.6"                     # 旁路由设置 DNS(填入DNS，多个DNS要用空格分开)(填0为不作修改)
